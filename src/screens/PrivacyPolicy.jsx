...
export const PrivacyPolicy = () => {
  return (
    <>
      <div className="relative flex flex-col w-full !select-none bg-fixed bg-panel dark:bg-panel-dark">
        <Header />
        <Link
          to="/"
        ...
        >
          <div className="flex flex-row items-center text-lg text-ink dark:text-ink-dark hover:underline cursor-pointer mb-2">
            <span className="mr-2">←</span>
            <p>Home</p>
          </div>
          <div className="max-w-4xl mx-auto bg-panel dark:bg-panel-dark shadow-lg rounded-xl p-8 md:p-12">
            <h1 className="text-3xl font-bold text-gray-900 mb-2 text-ink dark:text-ink-dark">
              Privacy Policy
            </h1>

            <p className="text-sm text-gray-500 mb-8 text-ink dark:text-ink-dark">
              Last Updated: 26 Dec 2025
            </p>

            <p className="text-gray-700 leading-relaxed mb-6 text-ink dark:text-ink-dark">
            ...
            {/* Section 1 */}
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-2 text-ink dark:text-ink-dark">
              1. Information We Collect
            </h2>

            <p className="text-gray-800 font-medium mb-1 text-ink dark:text-ink-dark">
              Information You Provide
            </p>
            <ul className="list-disc list-inside text-gray-700 mb-4 text-ink dark:text-ink-dark">
            ...
            <p className="text-gray-700 mb-6 text-ink dark:text-ink-dark">
            ...
            <p className="text-gray-700 leading-relaxed mb-3 text-ink dark:text-ink-dark">
              If you make a payment or contribution:
            </p>

            <ul className="list-disc list-inside text-gray-700 mb-6 text-ink dark:text-ink-dark">
            ...
            <p className="text-gray-700 mb-3 text-ink dark:text-ink-dark">
            ...
            <p className="text-gray-700 leading-relaxed text-ink dark:text-ink-dark">
