...
export const Header = () => {
  ...
  return (
    <>
      <div className="z-50 fixed flex flex-row justify-between items-center w-full h-16 px-4 shadow-md bg-cream/10 dark:bg-gray/10 backdrop-blur-lg border-b border-cream/30 dark:border-gray/30  rounded-b-[25px]">
        <a
          href="/"
