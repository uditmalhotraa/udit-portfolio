...
export const Header = () => {
  ...
  return (
    <>
      <div className="fixed flex flex-row justify-between items-center w-full h-16 px-4 shadow-container bg-cream/20 dark:bg-gray/20 backdrop-blur-lg z-20 border-b border-gray/20 dark:border-cream/20  rounded-b-[25px]">
        <a
          href="/"
