...
export const About = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-12">
      ...
      <div className="flex flex-col shadow-md px-4 rounded-2xl w-full h-auto border border-black/10 dark:border-white/20 backdrop-blur-sm bg-cream dark:bg-black will-change-transform transform-gpu">
        <div className="flex flex-row mb-4 pt-4 gap-3 items-center">
          <p className=" font-poppins text-3xl font-medium tracking-wide text-accent-light dark:text-accent-dark">
            Work
          </p>
      ...
      <div className="flex flex-col bg-gray/[0.015] dark:bg-cream/[0.015] rounded-2xl">
        <div className="flex flex-row gap-3 bg-cream dark:bg-black items-center rounded-2xl backdrop-blur-sm mb-4 w-full h-auto p-4 border border-b-0 z-10 border-black/10 dark:border-white/20 shadow-md will-change-transform transform-gpu">
          <p className=" font-poppins text-3xl font-medium tracking-wide text-accent-light dark:text-accent-dark">
            Projects
          </p>
        </div>
        <div className="flex flex-col gap-y-4">
          {projectsData.map((projectsData) => (
            <div
              ...
              className="flex flex-col backdrop-blur-8px md:flex-row gap-x-0 md:gap-y-0 shadow-md gap-y-4 rounded-2xl w-full h-auto border border-black/10 dark:border-white/20 z-10 bg-cream dark:bg-black will-change-transform transform-gpu"
            >
              <div
                className={`${
      ...
      <div className="flex flex-col shadow-md rounded-2xl px-4 w-full h-auto border border-black/10 dark:border-white/20 backdrop-blur-sm bg-cream dark:bg-black will-change-transform transform-gpu">
